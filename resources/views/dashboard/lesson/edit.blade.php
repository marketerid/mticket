...
@section('title', 'Edit lesson - Edu-tech.id')
                ...
                <form action="{{ route('lesson.update', $lesson->id) }}" method="post">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" name="description" class="form-control" cols="30" rows="10">{{ $lesson->description }}</textarea>
                        </div>
                    </div>
